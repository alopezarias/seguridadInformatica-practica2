...
/**
 * Clase Fuente, donde se encuentran los principales metodos relacionados con la
 * obtención de información de la fuente con la que trabajamos
 * 
 * @author angel
 *
 */
public class Fuente {
	...
	/**
	 * Array list que contiene todos los simbolos encontrados y su frecuencia en el
	 * texto.
	 */
	...
	/**
	 * Metodo que nos permite buscar el indice de un simbolo almacenado en el array
	 * list de todos los simbolos
	 * 
	...
	/**
	 * Metodo que aprovecha la funcionalidad de la interfaz Comparable, y ordena de
	 * mayor a menor los símbolos según su frecuencia
	 */
	...
	@Override
	/**
	 * Metodo que imprime por pantalla todos los datos de la fuente, sus frecuencias
